...
const options = {
	definition: {
		...
		info: {
			...
			version: '1.0.0',
			description: 'For academic purposes only! - BENR 2423 Database and Cloud System. Only admin required to authorise! A normal user/security would not need to authorise, just moving accroding to the endpoints will do.'
		},
		components: {
			securitySchemes: {
		  		bearerAuth: {
